...
from ...rodo_add_mx.models.special_dict import CaselessDictionary
...
#                 'methodo_pago': data.get('Comprobante',{}).get('@MetodoPago',''),
        ...
        if self.typo_de_combante in ['P','SP']:
            action_id = 'rodo_add_mx.action_xml_payment_reconcile_view'
        else:
            action_id = 'rodo_add_mx.action_xml_invoice_reconcile_view'
